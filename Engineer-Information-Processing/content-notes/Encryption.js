...
// - 대칭키 암호화 알고리즘(Symmetric-key Algorithm) == 비밀키 암호화 방식
...
// - 대칭키 암호화 알고리즘 종류
// (1) DES(Data Encryption Standard, 암호화 표준)
...
// (2) AES(Advanced Encryption Standard, 고급 암호화 표준)
...
// 알고리즘을 개발한 미국 MIT의 Rivest, Shamir, Adleman의 이니셜을 따서 RSA이다.
// RSA 암호 알고리즘의 핵심은 큰 정수의 소인수 분해가 어렵다는 점을 이용하여 암호화를 시킨다는 것이다.
...
// RSA 암호 알고리즘은 전자상거래에서 가장 흔히 쓰고있는 공개키 알고리즘이다.
