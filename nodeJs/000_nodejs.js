...
// 리터럴(literal) : 정보를 표현하는 기호.

// URL(Uniform Resource Locator) : 네트워크상에서 통합 자원의 위치를 나타내기 위한 규약
// ex)
// http://opentutorials.org:3000/main?id=HTML&page=12
// http : protocol(통신 규칙), 사용자가 서버에 접속할 때 어떤 방식으로 통신할 것인가에 대한 부분
// opentutorials.org : host(domain), 인터넷에 접속되어 있는 각각의 컴퓨터를 가리키는 주소
// 3000 : port, 포트 번호
// main : path, 파일 경로
// ?id=HTML&page=12 : query string, query string을 변경해서 웹 서버에 데이터를 전달할 수 있다.
