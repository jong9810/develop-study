...
// 매개변수와 인자의 개수가 다른 경우
// (1) 매개변수가 더 많은 경우 : 앞의 매개변수 부터 인자를 전달받고, 남은 매개변수에는 기본값은 undefined가 대입된다.
...
// js는 객체를 생성할 때 메모리의 새로운 위치에 속성을 저장하고, 객체에는 속성이 저장된 위치를 저장한다.
...
// 비교 연산자는 사실 값을 비교하는 것이 아니라 값이 저장된 위치를 비교하는 것이다!!
